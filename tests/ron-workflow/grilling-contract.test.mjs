...
test("decision policy ADRs retain their supersession chain", () => {
  ...
  const apertureAdr = read("docs/adr/0070-use-a-boundary-first-decision-aperture.md");
  const currentAdr = read("docs/adr/0071-reserve-boundaries-and-migration-costs.md");
