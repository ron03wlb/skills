...
- **[run-issue-workflow](./run-issue-workflow/SKILL.md)** — Reduce one exact producer handoff to READY, bind a deterministic Run identity, then deliver per-Spec Issue DAGs through the pi-workflow host with compact task outcomes and bounded recovery/writer waits.
