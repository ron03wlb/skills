...
const kinds = new Set(["spec_publication", "producer_handoff", "decomposition:v1", "implementation_complete", "implementation_blocked", "workflow_operation_identity_contract_adopted:v1", "workflow_artifacts_contract_adopted:v1"]);
