...
Apply the same inspection and freeze rule independently for the existing `workflow_artifacts_contract_adopted:v1` record and completions without `workflowArtifacts`. Never use either adoption record to classify the other field.
