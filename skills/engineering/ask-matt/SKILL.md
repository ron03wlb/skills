...
- **`/confirm-understanding`** — a bounded calibration after a grill, lesson, spec discussion, or meeting. It checks your mental model against an explicit Evidence Set with multiple-choice questions, and declares alignment only when every Core Proposition in the named scope passes without a core Evidence Gap.
