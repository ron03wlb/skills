...
The same target mutation writer applies equally to a direct human, an authorized coordinator, and planning producers. Other executions and writers for other targets may continue concurrently; no separate close-writer namespace, queue, daemon, or global workflow lock is added.
