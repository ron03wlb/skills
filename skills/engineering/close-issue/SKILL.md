...
Executable Issues use three-action closeout; Multi-Issue Specs use parent-only closeout. This skill never repairs product code, invokes `execute-issue`, reruns Standards or Spec review, runs aggregate verification, pushes, or deploys.
