...
- **[to-spec](./to-spec/SKILL.md)** — Revalidate settled scope, use an isolated planning lane for accepted document writes, and publish the Planning Seal plus exact Run handoff or decomposition command.
