...
7. Once all tickets are complete, call the Skill tool with "code-review" on the PR branch. Fix all issues raised by the code review in a single **implementer subagent**.
