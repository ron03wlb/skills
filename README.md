...
- **[ask-ron](./skills/engineering/ask-ron/SKILL.md)** — Route work through the Ron Issue delivery workflow without mutating state.
...
- **[setup-ron](./skills/engineering/setup-ron/SKILL.md)** — Configure durable tracker, Wiki, target, and Execution Lane contracts for the Ron workflow.
- **[wiki](./skills/engineering/wiki/SKILL.md)** — Initialize, resume, inspect, or synchronize the Ron Canonical Wiki from verified repository state.
- **[to-spec](./skills/engineering/to-spec/SKILL.md)** — Turn the current conversation into a spec and publish it to the issue tracker. No interview — just synthesizes what you've already discussed.
- **[to-spec-ron](./skills/engineering/to-spec-ron/SKILL.md)** — Publish a hash-verified Change Spec only after synthesis is complete.
- **[to-tickets](./skills/engineering/to-tickets/SKILL.md)** — Break any plan, spec, or conversation into a set of tracer-bullet tickets, each declaring its blocking edges — written as text in a local file, or as native blocking links on a real tracker.
- **[to-tickets-ron](./skills/engineering/to-tickets-ron/SKILL.md)** — Create bounded, dependency-ordered Executable Issues and optional per-Issue Grants.
...
- **[execute-issue](./skills/engineering/execute-issue/SKILL.md)** — Implement one authorized Ron Leaf or Standalone Issue and record `implemented_on_lane` evidence.
- **[close-issue](./skills/engineering/close-issue/SKILL.md)** — Close a verified Leaf, or reconcile and locally integrate a Parent or Standalone Issue.
